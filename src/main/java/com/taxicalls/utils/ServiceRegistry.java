...
/**
 * <p>
 * Manages the service registry API and the connection to the Zookeeper
 * backend.</p>
 *
...
public class ServiceRegistry {
    ...
    /**
     * <p>
     * Retrieves the Zookeeper service URI from the environemnt and initiates
     * the client.</p>
     */
    @Inject
    public ServiceRegistry() {
        try {
            String zookeeperUri = "discovery:2181";
    ...
    /**
     * <p>
     * Registers the service with Zookeeper. Creates an ephemeral entry for the
     * specified name and uri.</p>
     *
     * @param name The name of entry in service discovery, usually the services
     * name.
     * @param uri The URI to be saved of the service specified in the name
     * param.
     */
    public void registerService(String name, String uri) {
        try {
            ...
            String nodePath = zookeeper.create().withMode(CreateMode.EPHEMERAL_SEQUENTIAL).forPath(node + "/_", uri.getBytes());
    ...
    /**
     * <p>
     * Unregisters the service with Zookeeper. Removes the entry for the
     * specified name and uri if it exists.</p>
     *
     * @param name The name of entry in service discovery, usually the services
     * name.
     * @param uri The URI to be saved of the service specified in the name
    ...
    /**
     * <p>
     * Searches the registry for the provided service name and returns its
     * URI.</p>
     *
